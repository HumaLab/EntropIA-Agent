        ...
        let (kind, output, gate) = match w.step {
            ...
            7 => {
                ...
                let o: Report = self.call(
                    ...
                    &format!("{{title:string,sections:[{{title:string,text:string,claim_ids:string[]}}]}}; sin búsqueda. Cada sección conserva IDs de claims verificados. No agregues hechos nuevos. No escribas citas ni referencias: el código reproduce los fragmentos y arma «Fuentes citadas» a partir de los claim_ids. Respetá el encuadre que el investigador respondió en clarification. {} Incluí una sección «Limitaciones» con las limitaciones de interpretación: qué sesgo introducen las fuentes disponibles y qué conclusiones no se pueden sostener con ellas. No repitas archive_limitations ni coverage_warning: el código los imprime en esa misma sección", perfil.orden_informe),
